        ...
        <div class="flex justify-center border-b">
            <div class="flex justify-between w-full max-w-md px-4">  <!-- Changed this line -->
                ...
                <button id="notification-toggle" class="relative py-3 px-4 flex items-center justify-center flex-1 text-gray-600 hover:text-blue-500 focus:outline-none">
                    ...
                    <span id="notification-counter" class="absolute top-2 right-2 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 transform translate-x-1/2 -translate-y-1/2 bg-red-500 rounded-full {{ Auth::user()->unreadNotifications->count() > 0 ? '' : 'hidden' }}">
